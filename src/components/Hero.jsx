...
export default function Hero() {
    return (
        <div className="">
            ...
            <Link to="assignment_hub" className="flex pri rounded-lg my-8 py-2 w80 center gap-5"><p className=" font-medium">View Assignments</p><i className="far fa-arrow-right text-lg"></i></Link>
            </div>
