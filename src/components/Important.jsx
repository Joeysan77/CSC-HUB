...
export default function Important() {
     ...
     const filteredImportant = important.filter(a =>
  `${a.title} ${a.date} ${a.desc}`
    ...
    <>
        ...
        <div>
            ...
            <div className={` relative ${showDatalist ? 'mt-30' : ''} `}>
                ...
                <Search
            placeHolder='Search Important Announcements...'
            ...
            <div className="flex between w90 v-center my-5">
                <p className="text-lg font-medium">Important Announcements</p>
                <Count
                type='Important'
