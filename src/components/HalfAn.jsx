export default function HalfAn({status, title, date, desc}) {
    ...
    <>
        ...
        <div className="border w90 border-black/10 rounded-lg my-5 relative">
            ...
            <p className="tgray text-center my-5 w90">{desc}</p>
             <div className="absolute bottom-0 left-0 h-full w-full px-10 disappear "></div>
        </div>
